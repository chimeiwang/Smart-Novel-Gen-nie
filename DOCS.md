...
语言铁律：**仓库内所有自然语言代码注释、文档字符串、文档正文、计划、规格、审计、备注、示例说明和用户可见维护说明一律使用简体中文。新增或修改内容不得使用英文或繁体中文进行自然语言叙述。**代码标识符、协议字段、命令、文件路径、环境变量、第三方产品或库专名，以及无法改写的外部原文引用除外。历史文件只有在被修改时才必须同步清理其受影响部分，不要求一次性翻译全部归档内容。
...
- 能更新现有权威文档就不要新增。
- 新增文档的自然语言内容必须使用简体中文；只有代码标识符、协议字段、命令、文件路径、环境变量、第三方产品或库专名，以及无法改写的外部原文引用可以保留原文。
...
- 修改现有文档时，新增和改写的自然语言内容必须使用简体中文，并同步清理受影响段落中的英文或繁体中文叙述；不要求仅因本规则而一次性翻译未触及的历史归档。
...
- 验收新增或修改文档时，必须检查自然语言叙述是否全部为简体中文。
- 代码标识符、协议字段、命令、文件路径、环境变量、第三方产品或库专名，以及无法改写的外部原文引用不作为语言违规。
- 受影响段落仍存在英文或繁体中文自然语言叙述时，文档变更不得验收通过。

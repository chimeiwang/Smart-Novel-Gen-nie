...
PUBLIC_LONG_SERIAL_OPERATIONS: dict[str, PublicOperationDefinition] = {
    "create_lore": PublicOperationDefinition(
        operation="create_lore",
        workflow="long_serial",
        targetKind="chapter",
        allowedScopeKinds=("novel",),
        mutating=True,
        principalAgent="设定",
        reviewers=("校验",),
        artifactKind="agent_updates",
    ),
    "revise_lore": PublicOperationDefinition(
        operation="revise_lore",
        workflow="long_serial",
        targetKind="chapter",
        allowedScopeKinds=("novel",),
        mutating=True,
    ...
    "create_outline": PublicOperationDefinition(
    ...
    "revise_outline": PublicOperationDefinition(
    ...
    "manage_foreshadowing": PublicOperationDefinition(
        operation="manage_foreshadowing",
        workflow="long_serial",
        targetKind="chapter",
        allowedScopeKinds=("novel", "chapter"),
        mutating=True,
        principalAgent="剧情",
        reviewers=("校验",),
        artifactKind="agent_updates",

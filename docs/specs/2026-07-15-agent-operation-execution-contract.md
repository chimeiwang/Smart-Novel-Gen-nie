...
> **状态：已被 [2026-08-23 模型策略与局部修订规格](./2026-08-23-model-policy-deepseek-patch.md) 部分取代（superseded）。**
> 本文的 rewrite-only 与“不实现局部 patch”段落仅描述历史基线；当前行为以新规格、当前代码和测试为准。

## 状态

- 日期：2026-07-15
- 状态：历史基线，已被 2026-08-23 模型策略与局部修订规格部分取代（superseded）
